...
<br>
<br>
1. <h4>Create annotations using tool labelimg which create annotations in pascalvoc format.</h4>
<br>
2. <h4>Convert annotations into fiyzr format by</h4>
...
<br>
6.  <h4>Check your model in real time data</h4>
