...
<br>
<br>
1. <strong>Create annotations using tool labelimg which create annotations in pascalvoc format.</strong>
<br>
2. <strong>Convert annotations into fiyzr format by</strong>
...
(optional)
<br>
6.  <strong>Check your model in real time data</strong>
